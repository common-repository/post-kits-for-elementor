...
echo '<div class="alith-epk-block-container '.$atts['alith_block_post_widget_header_layout'].'">';
//Widget Title
...
//Select Layout
include ALITH_ELEMENTOR_POST_KITS_PATH . 'widgets/post-modules/' . $this->alith_module_layout . '.php' ;