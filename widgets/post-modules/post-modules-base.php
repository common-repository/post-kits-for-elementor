...
class Elementor_Post_Module_Base_Widgets extends Widget_Base {
    public $alith_title;
    public $alith_name;
    public $alith_icon;
    ...
    public function get_categories() {
        return ['Alith_Elementor_Post_Modules'];
    }
    ...
    public function render()
    {
        ...
        // FRONTEND-RENDER
        include ALITH_ELEMENTOR_POST_KITS_PATH.'widgets/post-modules/post-modules-frontend.php';
