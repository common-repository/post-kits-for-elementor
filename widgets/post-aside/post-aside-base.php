...
class Elementor_Post_Aside_Base_Widgets extends Widget_Base {
    public $alith_title;
    public $alith_name;
    public $alith_icon;
    ...
    public function get_categories() {
        return ['Alith_Elementor_Post_Aside'];
    }
    ...
    private function alith_tab_control_styling() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'icon',
                'condition' => [
                    'alith_block_post_post_meta_reading_time_show' => 'true',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'icon',
                'condition' => [
                    'alith_block_post_post_meta_comment_show' => 'true',
                ],
            ]
        );
    ...
    public function render()
    {
        ...
        // FRONTEND-RENDER
        include ALITH_ELEMENTOR_POST_KITS_PATH.'widgets/post-aside/post-aside-frontend.php';
