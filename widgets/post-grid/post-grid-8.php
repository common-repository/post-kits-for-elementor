...
for ($i = 0; $i < $slider_items; $i++) {
    ...
    $output .= '<div class="alith-layout alith-grid-layout-8 alith-block-'.esc_attr($rand) .esc_attr((empty($atts['alith_block_post_custom_class']) ? '' : $atts['alith_block_post_custom_class'])).'">
        ...
        while ($the_query->have_posts() && $post_count <= $length) {
            ...
            switch ($post_count) {
                case 1:                   
                    ...
                    $output .=      alith_grid_big_post_render($atts, 'item-space-bottom-2 item-space-right-2', $image_src);
                    $output .=  '</div>';
                    break;
                case 2:
                    $output .=  '<div class="alith-width-1-2">';                   
                    $output .=      '<div class="alith-width-1-2">';                   
                    $output .=          alith_grid_small_post_render($atts, 'item-space-left-2 item-space-right-2 item-space-bottom-2', $image_src);
                    $output .=      '</div>';
                    break;
                case 3:                    
                    $output .=      '<div class="alith-width-1-2">';                   
                    $output .=          alith_grid_small_post_render($atts, 'item-space-left-2 item-space-bottom-2', $image_src);
                    $output .=      '</div>';
                    break;
                case 4:                    
                    $output .=      '<div class="alith-width-1-2">';                   
                    $output .=          alith_grid_small_post_render($atts, 'item-space-left-2 item-space-right-2 item-space-top-2 item-space-bottom-2', $image_src);
                    $output .=      '</div>';
                    break;
                case 5:                    
                    $output .=      '<div class="alith-width-1-2">';                   
                    $output .=          alith_grid_small_post_render($atts, 'item-space-left-2 item-space-top-2 item-space-bottom-2', $image_src);
                    $output .=      '</div>';     
                    $output .=  '</div>';                    
                    break;
                case 6:
                    $output .=  '<div class="alith-width-1">';                   
                    $output .=      '<div class="alith-width-1-4">';                   
                    $output .=          alith_grid_small_post_render($atts, 'item-space-right-2 item-space-top-2', $image_src);
                    $output .=      '</div>';
                    break;
                case 7:                    
                    $output .=      '<div class="alith-width-1-4">';                   
                    $output .=          alith_grid_small_post_render($atts, 'item-space-left-2 item-space-right-2 item-space-top-2', $image_src);
                    $output .=      '</div>';
                    break;
                case 8:                    
                    $output .=      '<div class="alith-width-1-4">';                   
